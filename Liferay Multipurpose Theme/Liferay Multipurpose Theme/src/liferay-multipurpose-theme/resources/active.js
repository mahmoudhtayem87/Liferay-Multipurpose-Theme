(function ($) {
   ...
   $(".container-fluid.overflow-hidden.px-0.d-flex.flex-column").removeClass("overflow-hidden")
    ...
    amadoSearch.on('click', function () {
        $('#content').toggleClass('search-wrapper-on');
         if($(".control-menu-container").length>0)
                    {
                        $(".search-wrapper.section-padding-100").toggleClass("mobileMenuAdmin");
                    }

    });

    searchClose.on('click', function () {
        $('#content').removeClass('search-wrapper-on');
         $(".search-wrapper.section-padding-100").removeClass("mobileMenuAdmin");
    });
